        ...
        <div className={styles.modal}>
          <div className={styles.modalHeader}>
            ...
            <button
              ...
              onClick = {() => {
                reduxDispatch(changeModalStatus({ key: 'modal3', confirmModalStatus: false }));
          ...
          <div className={styles.modalFooter}>
            <button
              ...
              disabled={isModalAcceptBtnDissabled.modal3}
